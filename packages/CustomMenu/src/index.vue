          ...
          <div class="phone-box">
            ...
            <div class="menu__preview-bd">
              <div class="menu__preview-bottom">
                ...
                <div class="menu-list">
                  <a-button v-if="menu_data.button.length <= 0" type="text" class="menu-add-no-menu" @click="addMainMenu">
                ...
                <a-form ref="formVisible" :model="formData" :rules="rule" :style="{ width: '600px' }">
                  ...
                  <div class="custom-menu-type">
                    <a-form-item label="消息类型">
                      <a-radio-group v-model="menu_type" :default-value="menu_type" :options="menu_type_options" class="ml-4" />
                    </a-form-item>
                  </div>
...
<script lang="ts">
import { Button,Empty } from '@arco-design/web-vue';
